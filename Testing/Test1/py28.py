...
class Rectangle(Shape):     # Implementasi abstrak
...
class Shape2(ABC):  # Abstract Base Class
    @abstractmethod
    def area(self):
        pass
...
class Circle2(Shape2):  # Implementasi abstrak
...
class Rectangle2(Shape2):  # Implementasi abstrak
    def __init__(self, width, height):
        self.width = width
        self.height = height
...
shapes = [Circle2(5), Rectangle2(4, 6)]
for shape in shapes:
